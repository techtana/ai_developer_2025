document.addEventListener('DOMContentLoaded', () => {
    ...
    const lifeEvents = [
        { emoji: '💍', label: 'Marriage/Engagement', value: 'marriage' },
        { emoji: '👶', label: 'New Baby/Pregnancy', value: 'baby' },
        { emoji: '💔', label: 'Divorce/Breakup', value: 'divorce' },
        { emoji: '⚰️', label: 'Loss of Loved One', value: 'loss' },
        { emoji: '🏠', label: 'Moving/Relocation', value: 'moving' },
        { emoji: '💼', label: 'Job Change/Career Shift', value: 'job_change' },
        { emoji: '🎓', label: 'Graduation/Education', value: 'graduation' },
        { emoji: '🏥', label: 'Health Issues', value: 'health' },
        { emoji: '💰', label: 'Financial Changes', value: 'financial' },
        { emoji: '🌟', label: 'Major Achievement', value: 'achievement' }
    ];
